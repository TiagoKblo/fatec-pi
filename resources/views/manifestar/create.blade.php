                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            ...
                            <input type="number" class="form-control labeled" id="candidato-celular" name="docente_celular">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            ...
                            <input type="date" class="form-control labeled" id="contrato-data" name="partir_de">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            Grau <input type="number" name="docente_grau" id="categoria-docente-grau" class="form-control labeled">
                        </div>
                    </div>
                    ...
                    <div class="card-text row mb-2">
                        <div class="col">
                            ...
                            <input type="file" name="pontuacao" id="tabela-pontuacao" class="form-control labeled" accept=".pdf">
                        </div>

                        <div class="col">
                            <label for="comprovante">Documentos Comprobatórios</label>
                            <input type="file" name="comprovante" id="comprovante" class="form-control labeled" accept=".zip,.rar">
                        </div>
                    </div>

                    <div class="card-text">
                        <input type="radio" name="aceitar-termos" id="manifesto-aceitar-termos" class="form-check-input">
